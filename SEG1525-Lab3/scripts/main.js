...
class Item extends Entity{
  constructor(name, lactose, nut, vegetarian, gluten, organic, price, img){
...
var inventory = [new Item("Pasta", true, true, true, false, false, 1.99, "images/pasta.png"),
                new Item("Yogurt", false, true, true, true, true, 2.99, "images/yogurt.png"),
                new Item("Broccoli", true, true, true, true, true, 3.79, "images/broccoli.png"),
                new Item("Apples", true, true, true, true, true, 3.99, "images/apple.png"),
                new Item("Almonds", true, false, true, true, true, 3.99, "images/almond.png"),
                new Item("Milk", false, true, true, true, true, 4.99, "images/milk.png"),
                new Item("Eggs", true, true, false, true, true, 5.99, "images/egg.png"),
                new Item("Strawberries", true, true, true, true, true, 6.99, "images/strawberry.png"),
                new Item("Salmon", true, true, false, true, true, 10.99, "images/salmon.png"),
                new Item("Steak", true, true, false, true, true, 15.99, "images/steak.png")]
    ...
    for(var x = 0; x < selected.length; x++){
      if(inventory[i].name === selected[x]){
        if(selected2.includes(selected[x])){
          available += "<input type='checkbox' id='" + inventory[i].name + "' name='" + inventory[i].name + "' value='"+ inventory[i].name + "' checked><label for='" + inventory[i].name + "'>"  + inventory[i].name + " - $" + inventory[i].price + "</label><img class='items' src='" + inventory[i].img + "'/><br></input>";
        } else {
          available += "<input type='checkbox' id='" + inventory[i].name + "' name='" + inventory[i].name + "' value='"+ inventory[i].name + "'><label for='" + inventory[i].name + "'>"  + inventory[i].name + " - $" + inventory[i].price + "</label><img class='items' src='" + inventory[i].img + "'/><br></input>";
        }
      }
    }
